...
My research interest lies in **Large Language Models** (**LLMs**) for **Software Engineering**. Currently, I focus on LLMs for code, including code generation and automated program repair (APR). You can find my CV [here](/files/Yifeng_CV.pdf).<br/>
