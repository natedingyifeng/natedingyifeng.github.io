...
My research interest lies in **Large Language Models** (**LLMs**) for **Software Engineering**. Currently, I focus on using LLMs to improve automated debugging techniques, including **Automated Program Repair** (**APR**) and **Fault Localization** (**FL**). You can find my CV [here](/files/Yifeng_CV.pdf).<br/>
