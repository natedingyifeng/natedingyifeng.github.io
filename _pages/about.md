...
My research interest lies in **Large Language Models (LLMs) for Code**. My ongoing works include improving LLMs with **Instruction Tuning** and **Mixture-of-Experts** (**MoE**). You can find my CV [here](/files/Yifeng_CV.pdf).<br/>
